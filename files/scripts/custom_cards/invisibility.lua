function enabled_changed( entity_id, is_enabled )
    ...
    if is_enabled then
        LoadGameEffectEntityTo(root, "mods/copis_things/files/entities/misc/status_entities/effect_card_invisibility.xml")
    else
        for i, child_id in ipairs(EntityGetAllChildren(root) or {}) do
            ...
            if game_effect_component and EntityGetName(child_id) == "INVISIBILITY" then
