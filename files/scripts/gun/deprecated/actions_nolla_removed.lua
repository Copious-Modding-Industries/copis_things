...
local actions_removed = {
...

    {
        ...
        action              = function()
            ...
            "data/entities/misc/homing_projectile.xml,data/entities/particles/tinyspark_white.xml,"
            draw_actions(1, true)
        end,
    },
...
local len = #actions
for i = 1, #actions_removed do
    actions[len+i] = actions_removed[i]
end