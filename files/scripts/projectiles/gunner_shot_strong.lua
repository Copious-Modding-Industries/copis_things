...
local targets = EntityGetInRadiusWithTag( pos_x, pos_y, 192, "homing_target" )
...
if ( #targets > 0 ) then
	...
	local force = 110
	local projectile = "mods/copis_things/files/entities/projectiles/gunner_shot_strong.xml"
