...
ComponentSetValue2(projcomp, "collide_with_world",								bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "bounce_always",									bool[math.random(1,2)])
ComponentSetValue2(projcomp, "bounce_at_any_angle",								bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "velocity_sets_scale",								bool[math.random(1,2)])
ComponentSetValue2(projcomp, "velocity_sets_scale_coeff",						math.random(1,2))
ComponentSetValue2(projcomp, "velocity_sets_y_flip",							bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "on_death_gfx_leave_sprite",						bool[math.random(1,2)])
ComponentSetValue2(projcomp, "on_death_explode",								math.random()>0.9)
ComponentSetValue2(projcomp, "on_death_emit_particle",							bool[math.random(1,2)])
ComponentSetValue2(projcomp, "on_death_emit_particle_count",					math.random(1,100))
ComponentSetValue2(projcomp, "die_on_liquid_collision",							bool[math.random(1,2)])
ComponentSetValue2(projcomp, "die_on_low_velocity",								bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "ground_collision_fx",								bool[math.random(1,2)])
ComponentSetValue2(projcomp, "explosion_dont_damage_shooter",					bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "penetrate_entities",								bool[math.random(1,2)])
ComponentSetValue2(projcomp, "on_collision_die",								bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "damage_scaled_by_speed",							bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "friendly_fire",									bool[math.random(1,2)])
...
ComponentSetValue2(projcomp, "never_hit_player",								bool[math.random(1,2)])
ComponentSetValue2(projcomp, "collect_materials_to_shooter",					false)
ComponentSetValue2(projcomp, "play_damage_sounds",								bool[math.random(1,2)])
...
ComponentSetValue2(spritecomp, "emissive",						bool[math.random(1,2)])
ComponentSetValue2(spritecomp, "additive",						bool[math.random(1,2)])
ComponentSetValue2(spritecomp, "fog_of_war_hole",				bool[math.random(1,2)])
...
ComponentSetValue2(spritecomp, "has_special_scale",				bool[math.random(1,2)])
