...
if game_area_effect then
    ...
    for _,particle_emitter in pairs( EntityGetComponent( entity, "ParticleEmitterComponent", "spread_damage" ) or {} ) do
        local min, max = ComponentGetValue2( particle_emitter, "area_circle_radius" ) or 0, 0;
        if min ~= -1 then
