function shot(projectile_entity)
    ...
    local dmcs = EntityGetComponentIncludingDisabled(shooter, "DamageModelComponent")
    local vsc = EntityGetFirstComponentIncludingDisabled(shooter, "VariableStorageComponent", "protagonist_bonus");
    local protagonist_bonus = ComponentGetValue2(vsc, "value_float")
    ...
    multiplier = 1.0 + protagonist_bonus * adjuted_ratio;
